...
return [
    ...
    'description' => 'Documentación Oficial del API Backend (REST) para el Sistema Core de Logística. Incluye facturación, envíos, finanzas y autenticación.',
    ...
    'intro_text' => <<<'INTRO'
            ...
            <aside>
            Las llamadas documentadas aquí se enfocan en la integración directa del frontend u otros clientes del ecosistema (como apps móviles, integradores o POS). 
            Asegúrate de agregar el Header `Authorization: Bearer {tu-token}` en todas las rutas a partir del flujo de registro.
            </aside>
        INTRO,
    ...
    'auth' => [
        ...
        'extra_info' => <<<'AUTH_INFO'
        Para probar los endpoints protegidos, utiliza las siguientes credenciales por defecto:
        
        **Email**: `admin@admin.pe`
        **Password**: `SecureAdmin2026!@#`
        
        El token se genera automáticamente al hacer login con estas credenciales.
        AUTH_INFO,
    ],
